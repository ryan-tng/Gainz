# Gainz — Waitlist Landing Page

Marketing + waitlist landing page for **Gainz** (working title), a gym workout-tracker app.
Built with Next.js (App Router) + Tailwind CSS, deployed on Vercel. Emails are collected via
Kit (ConvertKit).
